      ...
      >
        ...
        <Modal open={isModalOpen} onClose={() => setIsModalOpen(false)}>
          ...
          <Box sx={style}>
            ...
            >
              Esta é uma versão de demonstração, por este motivo todos os
              parâmetros estão pré-definidos pelo sistema. Sendo assim, neste
              momento os itens de parametrização estarão bloqueados para suas
              respectivas personalizações.
            </Typography>
