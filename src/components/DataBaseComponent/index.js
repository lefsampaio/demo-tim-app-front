        ...
        <>
            ...
            <Container sx={{ mt: 12 }}>
                <Box sx={{
                    ...
                    <Box>
                        <Typography component='h2' mb={3} sx={{ fontSize: '18px', fontWeight: '700', textAlignLast: 'left', color: '#2F2F2F' }}>Upload de arquivos de texto</Typography>
                        <Typography mb={5} sx={{ color: '#565656', fontSize: '16px', textAlignLast: 'left', }}>Utilize este espaço para fornecer informações ao sistema, a respeito da sua marca ou produto.</Typography>
                    </Box>
                </Box>
                <Box
                    sx={{
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }} mt={9}>
                    <Button sx={{
                        backgroundColor: '#0026D9', textTransform: 'none', fontSize: '16px', width: '256px',
                        height: '56px', borderRadius: '8px'
                    }} href="/painel" variant="contained">voltar</Button>
