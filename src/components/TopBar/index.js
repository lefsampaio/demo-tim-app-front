...
const TopBar = ({ title, component: Component }) => {
  ...
  return (
    <AppBar position="static" sx={{ backgroundColor: '#fff' }}>
      <Toolbar sx={{ display: Component && 'grid', gridTemplateColumns: Component && '2fr 2fr 0fr 0fr 0fr' }}>
        <Typography component="h1" variant="h6" color="customBlue" noWrap sx={{ flexGrow: 1, marginLeft: { md: '250px' }, color:'#2F2F2F' }}>
          <IconButton
